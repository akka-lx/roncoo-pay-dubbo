 ...
 * @版本: 1.0 .
 */
public class TradeDubboProvider {
	private static final Log log = LogFactory.getLog(TradeDubboProvider.class);
	...
	public static void main(String[] args) {
		...
		try {
			...
			*/
			...
			log.error("== TradeDubboProvider context start error:", e);
		}

		synchronized (TradeDubboProvider.class) {
			while (true) {
				try {
					TradeDubboProvider.class.wait();

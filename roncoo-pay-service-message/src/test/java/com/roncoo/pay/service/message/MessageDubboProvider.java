 ...
 * @版本: 1.0 .
 */
public class MessageDubboProvider {
	private static final Log log = LogFactory.getLog(MessageDubboProvider.class);
...
//			System.out.println(messages.size());
			...
			log.error("== MessageDubboProvider context start error:", e);
		}

		synchronized (MessageDubboProvider.class) {
			while (true) {
				try {
					MessageDubboProvider.class.wait();
